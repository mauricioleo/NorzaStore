...
-->
	...
	<div class="well np">
            ...
            <ul class="list-group">
                <li class="list-group-item">Nombre: <% out.println(sesion.getAttribute("usuario")); %></li>
                <li class="list-group-item">Contraseña: <% out.println(sesion.getAttribute("password")); %></li>
                <li class="list-group-item">Sesion ID : <% out.println(sesion.getId()); %></li>
            </ul>
        </div>
<!--
Slider Secundario
